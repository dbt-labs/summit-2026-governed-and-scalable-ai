...
final as (
    ...
    select
        ...
        (brew_events.batch_size * potion_supply_costs.potion_supply_cost_copper)::number(18, 2) as batch_supply_cost_copper,
        potion_supply_costs.has_hazardous_ingredient,
        potion_supply_costs.minimum_supplier_reliability_rating
    from brew_events
